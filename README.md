...
>
> Utilizei conceitos de JavaScript e ES6 como: manipulação do DOM, Arrays, Funções nativas e manipulação do BOM. Apliquei conceitos de responsividade e flexbox. Voltado ao ReactJS utilizei Hooks, libs, manipulação de API (web services), renderização condicional e componentização avançada (state lift).
